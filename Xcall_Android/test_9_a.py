# -*- coding:utf-8 -*-
""" 情境：1.A拨打B，B接听，2.AB通话中，3.A静音，4.验证保持操作成功，5.A取消静音
    结果：6.A成功取消静音 """
...
class SimpleAndroidTests(unittest.TestCase):
    ...
    def test_9_a(self):
        ...
        self.a_mute()
        # 4.验证成功静音
        result_mute = verify_mute(self)
        self.assertTrue(result_mute)
        # 5.A取消静音
        self.a_mute()
        # 6.A取消静音成功
        result_mute_cancelled = verify_mute_cancelled(self)
        self.assertTrue(result_mute_cancelled)
